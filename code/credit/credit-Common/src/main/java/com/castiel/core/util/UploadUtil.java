...
import com.castiel.core.support.fastdfs.FileManager;
import com.castiel.core.support.fastdfs.FileModel;
...
public final class UploadUtil {
	...
	public static String getUploadDir(HttpServletRequest request) {
		return request.getServletContext().getRealPath(uploadFileDir+request.getAttribute("folderName")+"/")+"/";
	}
